...
enum
{
	...
	// 计算出来的常量。MaxSmallSize和msize.c的算法制造除了一些分配好的类大小和空间的对应。
	// NumSizeClass就是这个对应的数目。由于需要这个对应的静态长度，所以这个值在这里是需要的。
	// 当msize.c在制定选择算法的时候，它也必须要满足NumSizeClasses的限制
	NumSizeClasses = 61,
